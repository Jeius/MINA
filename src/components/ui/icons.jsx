...
export const PlaceHolderSVG = (props) => (
    ...
    >
        <path
            d="M508.468 446.59 404.86 261.644a27.691 27.691 0 0 0-24.158-14.158H131.3a27.688 27.688 0 0 0-24.158 14.158L3.533 446.59a27.69 27.69 0 0 0 24.158 41.223h456.62a27.689 27.689 0 0 0 24.157-41.223z"
            style={{
                fill: "#30767a",
            }}
        />
        <path
            d="M256.001 247.486H131.3a27.688 27.688 0 0 0-24.158 14.158L3.533 446.59a27.69 27.69 0 0 0 24.158 41.223h228.31V247.486z"
            style={{
                fill: "#4ab6bf",
            }}
        />
        <path
            d="m374.894 285.086 92.505 165.126H44.602l92.505-165.126h237.787m5.808-37.6H131.3a27.688 27.688 0 0 0-24.158 14.158L3.533 446.59a27.69 27.69 0 0 0 24.157 41.223h456.62a27.689 27.689 0 0 0 24.158-41.223L404.859 261.644a27.687 27.687 0 0 0-24.157-14.158z"
            style={{
                fill: "#005049",
            }}
        />
        <path
            d="M256.001 450.214H44.602l92.505-165.126h118.894v-37.6H131.3a27.688 27.688 0 0 0-24.158 14.158L3.533 446.59a27.69 27.69 0 0 0 24.157 41.223H256v-37.599h.001z"
            style={{
                fill: "#30767a",
            }}
        />
        <path
            d="M256.001 24.188c55.58 0 100.635 45.056 100.635 100.635 0 40.726-54.035 129.244-82.916 173.646a21.144 21.144 0 0 1-17.73 9.616 21.145 21.145 0 0 1-17.718-9.629c-28.882-44.407-82.907-132.911-82.907-173.633 0-55.579 45.057-100.635 100.636-100.635z"
            style={{
                fill: "#940009",
            }}
        />
        <path
            d="M155.365 124.824c0 40.726 54.035 129.244 82.916 173.646a21.14 21.14 0 0 0 17.72 9.603V24.188c-55.579 0-100.636 45.056-100.636 100.636z"
            style={{
                fill: "#ff0029",
            }}
        />
        ...
        />
        <path
            d="M213.977 123.718c0 23.209 18.814 42.024 42.024 42.024V81.694c-23.208 0-42.024 18.815-42.024 42.024z"
            style={{
                fill: "#fff",
            }}
        />
